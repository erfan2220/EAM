...
const Menu = () => {
    ...
    return (
        <div className="w-100 flex flex-row justify-between items-center py-[16px] pl-[56px] bg-[#131423]">
            <div className="flex flex-row gap-[35px]">

                <span className="text-[21px] text-white">OSS Portal</span>
            </div>
            <div className="relative flex flex-row gap-[23px]  pr-[56px]">
                <img className="cursor-pointer" src="./Menu/Gear.svg" alt=""/>
                <img className="cursor-pointer" src="./Menu/Profile.svg" alt="" onClick={()=>{
                    handleMenu()
                }}/>
                {
                    openMenu && (
